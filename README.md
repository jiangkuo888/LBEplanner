...
- 新增“调节内容转向”模式，支持只在该模式下记录和应用BlockRotateZAxisValue。
- 批量旋转动块时，BlockRotateZAxisValue的更新逻辑优化：
  - 只对选中动块中index最小的动块持续更新BlockRotateZAxisValue。
  - 支持“需要更新的动块”机制，保证旋转期间持续同步BlockRotateZAxisValue，直到取消选中。
- 修复了旋转过程中BlockRotateZAxisValue未能实时刷新到画布显示的问题（useRef同步needUpdateIndices）。
- 支持一键回退和版本部署，线上与本地体验一致。
- 其它细节体验优化与bug修复。
...
- [ ] 人流模拟
- [ ] 撤销/重做
- [ ] 按照流程一步一步操作 1.选择场地 、选择内容 2.导入场地图 3.绘制场地边界点 4.从本地或云端列表（其他项目）导入参考动块配置文件 5.调整动块适配该场地 6.人流模拟 7.确认动块并保存、下载 8.发布到头盔
- [ ] 优化操作说明，快捷键说明
- [ ] 
- [ ] 
- [ ] 
